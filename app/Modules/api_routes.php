...
include_once  base_path("app/Modules/Salary/Route.php");

include_once  base_path("app/Modules/LoanProvider/Route.php");
include_once  base_path("app/Modules/LoanPayment/Route.php");

include_once  base_path("app/Modules/JamanotProvider/Route.php");
include_once  base_path("app/Modules/JamanotPayment/Route.php");

include_once  base_path("app/Modules/OfficeRent/Route.php");
include_once  base_path("app/Modules/HouseRent/Route.php");
