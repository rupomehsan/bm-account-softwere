...
<th class='cursor_n_resize'>  is_approved </th> 
<th class='cursor_n_resize'>  request_type </th> 
...
<th class='cursor_n_resize'> {{ item.is_approved}} </th> 
<th class='cursor_n_resize'> {{ item.request_type}} </th> 
                                        <td>
                                            {{ item.status }}
                                        </td>
                                        <td>
