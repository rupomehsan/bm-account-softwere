                            ...
                            <thead class="table-light">
                                <tr class="t-head">
                                    ...
                                    <th aria-label="id" class="cursor_n_resize">
                                        ID
                                        <!---->
                                    </th><th class='cursor_n_resize'>  product_id </th> 
<th class='cursor_n_resize'>  asset_quotation_id </th> 
<th class='cursor_n_resize'>  shope_name </th> 
<th class='cursor_n_resize'>  address </th> 
<th class='cursor_n_resize'>  shop_contact </th> 
<th class='cursor_n_resize'>  price </th> 
<th class='cursor_n_resize'>  quotation_image </th> 
<th class='cursor_n_resize'>  brand </th> 
                            ...
                            <tbody class="table-border-bottom-0" v-if="loaded">
                                <tr v-for="(item, index) in all_data.data" :key="index">
                                    ...
                                    <td>{{ item.id }}</td><th class='cursor_n_resize'> {{ item.product_id}} </th> 
<th class='cursor_n_resize'> {{ item.asset_quotation_id}} </th> 
<th class='cursor_n_resize'> {{ item.shope_name}} </th> 
<th class='cursor_n_resize'> {{ item.address}} </th> 
<th class='cursor_n_resize'> {{ item.shop_contact}} </th> 
<th class='cursor_n_resize'> {{ item.price}} </th> 
<th class='cursor_n_resize'> {{ item.quotation_image}} </th> 
<th class='cursor_n_resize'> {{ item.brand}} </th> 
                                        <td>
                                            {{ item.status }}
                                        </td>
                                        <td>
            ...
            import { product_price_setup_store } from './setup/store';
            ...
            export default {
                ...
                methods: {
                    ...mapActions(product_price_setup_store, {
                        get_all_data: 'all',
                        delete_data: 'delete',
                ...
                computed: {
                    ...mapState(product_price_setup_store, {
                        all_data: 'all_data',
                    })
                }
            }
