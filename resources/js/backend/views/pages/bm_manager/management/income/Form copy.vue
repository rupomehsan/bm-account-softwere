                                    ...
                                    <div class="admin_form form_1">
                                        <template v-for="(
                                            ...
                                            <common-input :label="form_field.label" :type="form_field.type"
                                                ...
                                                :searchable="form_field.searchable"
                                                :labelParam="form_field.labelParam" />
                                        </template>
                                    </div>
                                </div>
                            </div>
    ...
    created: async function () {
        ...
        if (id) {
            ...
            if (this.single_data) {
                ...
                this.form_fields[1].labelParam = this.single_data.page_item_count
                this.form_fields[2].labelParam = this.single_data.receipt_book_item_count
                this.form_fields[7].value.id = this.single_data.branch_id
                this.form_fields[7].value.name = this.single_data.user.full_name
            }
            ...
            if (this.latest_income_data) {
                this.form_fields[1].value = this.latest_income_data.cash_book_page_no
                this.form_fields[1].labelParam = this.latest_income_data.page_item_count
                this.form_fields[2].value = this.latest_income_data.account_receipt_book_no
                this.form_fields[2].labelParam = this.latest_income_data.receipt_book_item_count
                this.form_fields[3].value = Number(this.latest_income_data.account_receipt_no) + 1
                // this.form_fields[3].value = Number(this.latest_income_data.account_receipt_no) + 1
            }
        }
    },
