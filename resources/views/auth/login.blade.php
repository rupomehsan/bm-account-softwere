...
<body>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center vh-100">
            <div class="col-md-6 ">
                <form id="formSubmit" onsubmit="onSubmit()" method="POST" action="{{ route('login') }}">
                    <h3>Login Here</h3>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" placeholder="Enter your password" name="password" value="@12345678"
                            onchange="errorReset(event)">
                        <p class="alert-danger" id="password"></p>
                    </div>

                    <button class="mt-5 btn btn-outline-success" type="submit" id="spiner">
                        <span>Log In</span>
